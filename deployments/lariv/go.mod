...
require (
	...
	github.com/lariv-in/lago/plugins/p_contacts v0.5.10
	github.com/lariv-in/lago/plugins/p_dashboard v0.5.10
	github.com/lariv-in/lago/plugins/p_filesystem v0.5.10
	github.com/lariv-in/lago/plugins/p_forms v0.0.0-20260403180717-e54a55236dd3
	github.com/lariv-in/lago/plugins/p_lacerate v0.0.0-20260410184645-ccd14ffd0cf8
