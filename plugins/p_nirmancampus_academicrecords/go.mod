module github.com/lariv-in/lago/plugins/p_nirmancampus_academicrecords
...
require (
	...
	github.com/lariv-in/lago/plugins/p_nirmancampus_courses v0.0.0-00010101000000-000000000000
