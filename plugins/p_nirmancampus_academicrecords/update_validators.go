...
// formPatcherAcademicRecordOptionalCourseCount ensures OptionalCourses length matches
// ProgramStructureUnit.OptionalCourseCount for this record's program and term.
func formPatcherAcademicRecordOptionalCourseCount(_ *views.View, r *http.Request, values map[string]any, formErrors map[string]error) (map[string]any, map[string]error) {
	if formErrors == nil {
