		...
		Children: []components.PageInterface{
			&components.DataTable[VNode]{
				...
				Columns: []components.TableColumn{
					...
					{Label: "Size", Key: "Size", Children: []components.PageInterface{&components.FieldText{Getter: vnodeSizeForKey("$row")}}},
					{Label: "Items", Key: "Items", Children: []components.PageInterface{&components.FieldText{Getter: vnodeChildrenCountForKey("$row")}}},
